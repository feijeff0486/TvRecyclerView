 ...
 * <p> Description: 焦点剧中显示</p>
 * <p> Created by <b>高晓峰</b> on 8/2/2017. </p>
 * <p> ChangeLog: </p>
 * <li> 高晓峰 on 8/2/2017 do fisrt create. </li>
 */

public class CenterScrollVie extends FrameLayout implements NestedScrollingParent,
    ...
    private static final String TAG = "CenterNestedScrollView";
    /**
    ...
    public CenterScrollVie(Context context) {
        this(context, null);
    }

    public CenterScrollVie(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CenterScrollVie(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean arrowScroll(int direction) {
        ...
        if (nextFocused != null && isWithinDeltaOfScreen(nextFocused, maxJump, getHeight())) {
            ...
            // compute the offset Y to move to center for focused view.
            int scrollDeltaOffset = getMoveToCenterOffset(nextFocused);
            doScrollY(scrollDelta + scrollDeltaOffset);
            ...
            doScrollY(direction == View.FOCUS_DOWN ? scrollDelta : -scrollDelta);// orignal command.
        }
    ...
    private int getMoveToCenterOffset(View focusView) {
        ...
        int distance = (int) ((getY() + getHeight() / 2) - focusView.getHeight() * focusView.getScaleY() / 2);
        if (position[1] != distance) {
            int scrollDelta = position[1] - distance;
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(CenterScrollVie v, int scrollX, int scrollY,
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final CenterScrollVie nsvHost = (CenterScrollVie) host;
